...
#load("C:/Users/moradirekabh/Downloads/prcp_stns_cheasapeake_20060101_20151231.rdata")
#load("C:/Users/moradirekabh/Downloads/prcp_stns_cheasapeake_20060101_20151231 (1).rdata")
load('/storage/home/jwo118/scratch/ncar_statmos/data/prcp_stns_cheasapeake_20110101_20151231.rdata')
...
mask_time1 <- df$time < as.POSIXct('2015-12-01')
dftrain <- df_prcp[mask_time1,]
dftest <- df_prcp[!mask_time1,]
...
neonet2 <- neuralnet(binresptr ~ lattr + lontr + ycostr, trainset1, 
                     hidden = 2,  act.fct = "logistic",lifesign = "minimal",
                     stepmax = 1e+05,linear.output = FALSE, threshold = .1)